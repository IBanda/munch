...
exports.handlers = [
    msw_1.rest.get('https://maps.googleapis.com/maps/api/place/nearbysearch/json', (req, res, ctx) => {
        return res(ctx.status(200), ctx.json({
            results: places,
        }));
    }),
    msw_1.rest.get('https://maps.googleapis.com/maps/api/place/details/json', (req, res, ctx) => {
