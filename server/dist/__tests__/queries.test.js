...
`;
describe('Queries', () => {
    test('[Query]:Should get list of places', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('[Query]:Should get place details', () => __awaiter(void 0, void 0, void 0, function* () {
        const { query } = yield testClient_1.testClient();
